    ...
    "src/chess-app.jsx"() {
      ...
      function Chess3D() {
        ...
        useEffect(() => {
          ...
          scene.add(cool);
          const darkSideBack = new THREE.PointLight(16766624, 1.25, 42, 2);
          darkSideBack.position.set(0, 5.8, -12.4);
          scene.add(darkSideBack);
          const darkSideFill = new THREE.DirectionalLight(16770239, 0.52);
          darkSideFill.position.set(0, 7, -13.8);
          ...
          const makeSunStarTex = (sz = 512) => {
            ...
            halo.addColorStop(0.6, "rgba(255,165,80,0.22)");
            ...
            for (let i = 0; i < 16; i++) {
              ...
              const w = sz * (6e-3 + Math.random() * 6e-3);
